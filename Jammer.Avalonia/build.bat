...
@REM COPY jammer.exe
COPY /B /Y "%sourceFolder%\Jammer.Avalonia.exe" "%targetFolder%\%jammer.exe"
COPY /B /Y "%sourceFolder%\clrcompression.dll" "%targetFolder%\clrcompression.dll"
COPY /B /Y "%sourceFolder%\av_libglesv2.dll" "%targetFolder%\av_libglesv2.dll"
COPY /B /Y "%sourceFolder%\libSkiaSharp.dll" "%targetFolder%\libSkiaSharp.dll"
COPY /B /Y "%sourceFolder%\libHarfBuzzSharp.dll" "%targetFolder%\libHarfBuzzSharp.dll"
