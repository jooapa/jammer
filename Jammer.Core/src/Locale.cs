    ...
    public static class Locale
    {
        ...
        */
        ...
        public static class Settings
        {
            ...
            public static string IntegrationsDescription = CheckValueLocale("Settings", "IntegrationsDescription", "YouTube, yt-dlp, SoundCloud, and Spotify");
            ...
            public static string SpotifyStatus = CheckValueLocale("Settings", "SpotifyStatus", "Spotify authorization");
            public static string SpotifyClientId = CheckValueLocale("Settings", "SpotifyClientId", "Spotify application client ID");
            public static string SpotifyAuthorize = CheckValueLocale("Settings", "SpotifyAuthorize", "Authorize Spotify");
            public static string SpotifyPlaylists = CheckValueLocale("Settings", "SpotifyPlaylists", "Import or update Spotify playlists");
            public static string SpotifyResolver = CheckValueLocale("Settings", "SpotifyResolver", "Spotify track resolver");
            public static string SpotifyDisconnect = CheckValueLocale("Settings", "SpotifyDisconnect", "Disconnect Spotify");
            public static string SpotifyNotAuthorized = CheckValueLocale("Settings", "SpotifyNotAuthorized", "Not authorized");
            public static string SpotifyAuthorized = CheckValueLocale("Settings", "SpotifyAuthorized", "Authorized");
            public static string SpotifyClientIdPrompt = CheckValueLocale("Settings", "SpotifyClientIdPrompt", "Paste the client ID from your Spotify developer application. No client secret is needed.");
            public static string SpotifyClientIdTitle = CheckValueLocale("Settings", "SpotifyClientIdTitle", "Spotify client ID");
            public static string SpotifyRedirectHelp = CheckValueLocale("Settings", "SpotifyRedirectHelp", "Register this exact redirect URI in the Spotify app: {0}");
            public static string SpotifyAuthorizedMessage = CheckValueLocale("Settings", "SpotifyAuthorizedMessage", "Authorized as {0}.");
            public static string SpotifyPlaylistMenu = CheckValueLocale("Settings", "SpotifyPlaylistMenu", "Choose a Spotify playlist to import or update");
            public static string SpotifyUpdateAll = CheckValueLocale("Settings", "SpotifyUpdateAll", "Update all imported playlists");
            public static string SpotifyImported = CheckValueLocale("Settings", "SpotifyImported", "imported — select to update");
            public static string SpotifyNotImported = CheckValueLocale("Settings", "SpotifyNotImported", "select to import");
            public static string SpotifyImportComplete = CheckValueLocale("Settings", "SpotifyImportComplete", "Spotify playlist saved to {0}. Track matching continues in the background.");
            public static string SpotifyUpdateComplete = CheckValueLocale("Settings", "SpotifyUpdateComplete", "Updated {0} imported Spotify playlist(s).");
            public static string SpotifyChooseResolver = CheckValueLocale("Settings", "SpotifyChooseResolver", "Choose where imported Spotify tracks are matched.");
            public static string SpotifyDisconnectPrompt = CheckValueLocale("Settings", "SpotifyDisconnectPrompt", "Disconnect Spotify? Enter {0} to confirm.");
            public static string SpotifyNoPlaylists = CheckValueLocale("Settings", "SpotifyNoPlaylists", "No owned or collaborative playlists are available.");
